...
interface IndigoRoomProps { onBack: () => void; }
...
export function IndigoRoom({ onBack }: IndigoRoomProps) {
  const [events, setEvents] = useState<Event[]>([
    { id: "1", title: "Training Session", time: "09:00 - 13:00", attendees: 22, date: "Nov 21, 2025", room: "training" },
    { id: "2", title: "Team Building", time: "15:00 - 17:00", attendees: 25, date: "Nov 22, 2025", room: "event" }
  ]);
  ...
  const rooms: Room[] = [
    { id: "training", name: "Training Hall", x: "8%", y: "10%", width: "44%", height: "42%", color: "#f5f5f5" },
    { id: "event", name: "Event Space", x: "56%", y: "10%", width: "36%", height: "42%", color: "#e5e5e5" },
    { id: "prep", name: "Prep Area", x: "8%", y: "56%", width: "30%", height: "36%", color: "#d4d4d4" },
    { id: "storage", name: "Storage", x: "42%", y: "56%", width: "22%", height: "36%", color: "#c4c4c4" },
    { id: "control", name: "Control Room", x: "68%", y: "56%", width: "24%", height: "36%", color: "#b5b5b5" }
  ];
      ...
      <DraggableActionCircles rooms={rooms}>
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <button onClick={onBack} className="flex items-center gap-2 text-gray-700 hover:text-gray-900 transition-colors"><ArrowLeft className="w-5 h-5" /><span>Back to Floor Plan</span></button>
            <div className="px-6 py-2 bg-gray-800 text-white rounded-full">Roof (Level 7)</div>
          </div>
                ...
                {rooms.map((room) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-8 h-1.5 bg-gray-800 rounded" />
                    </motion.button>
                  );
                })}
              </div>
              <div className="mt-4 text-sm text-gray-700"><p>Total Floor Area: 530 m² | Floor: Roof</p></div>
            </motion.div>
