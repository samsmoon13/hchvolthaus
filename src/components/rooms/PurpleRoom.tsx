...
interface PurpleRoomProps { onBack: () => void; }
...
export function PurpleRoom({ onBack }: PurpleRoomProps) {
  const [events, setEvents] = useState<Event[]>([
    { id: "1", title: "Executive Meeting", time: "16:00 - 18:00", attendees: 6, date: "Nov 16, 2025", room: "exec" }
  ]);
  ...
  const rooms: Room[] = [
    { id: "exec", name: "Executive Suite", x: "10%", y: "10%", width: "45%", height: "40%", color: "#f5f5f5" },
    { id: "private", name: "Private Office", x: "60%", y: "10%", width: "30%", height: "40%", color: "#e5e5e5" },
    { id: "lounge", name: "VIP Lounge", x: "10%", y: "55%", width: "35%", height: "37%", color: "#d4d4d4" },
    { id: "meeting", name: "Meeting Pod", x: "50%", y: "55%", width: "40%", height: "37%", color: "#c4c4c4" }
  ];
      ...
      <DraggableActionCircles rooms={rooms}>
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="px-6 py-2 bg-gray-800 text-white rounded-full">Third Floor (Level 6)</div>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-2 bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mt-4 text-sm text-gray-700"><p>Total Floor Area: 420 m² | Floor: Third Floor</p></div>
            </motion.div>
