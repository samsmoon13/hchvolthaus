...
interface YellowRoomProps { onBack: () => void; }
...
export function YellowRoom({ onBack }: YellowRoomProps) {
  const [events, setEvents] = useState<Event[]>([
    { id: "1", title: "Creative Brainstorm", time: "13:00 - 15:00", attendees: 8, date: "Nov 15, 2025", room: "creative" }
  ]);
  ...
  const rooms: Room[] = [
    { id: "creative", name: "Creative Space", x: "10%", y: "15%", width: "38%", height: "35%", color: "#f5f5f5" },
    { id: "workshop", name: "Workshop", x: "52%", y: "15%", width: "38%", height: "35%", color: "#e5e5e5" },
    { id: "storage", name: "Storage", x: "10%", y: "55%", width: "25%", height: "35%", color: "#d4d4d4" },
    { id: "lounge", name: "Lounge", x: "40%", y: "55%", width: "50%", height: "35%", color: "#c4c4c4" }
  ];
      ...
      <DraggableActionCircles rooms={rooms}>
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="px-6 py-2 bg-gray-800 text-white rounded-full">Mezzanine (Level 3)</div>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-2 bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mt-4 text-sm text-gray-700"><p>Total Floor Area: 390 m² | Floor: Mezzanine</p></div>
            </motion.div>
