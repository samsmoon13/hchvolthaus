...
interface TealRoomProps { onBack: () => void; }
...
export function TealRoom({ onBack }: TealRoomProps) {
  const [events, setEvents] = useState<Event[]>([
    { id: "1", title: "Focus Group", time: "11:00 - 12:30", attendees: 14, date: "Nov 20, 2025", room: "focus" }
  ]);
  ...
  const rooms: Room[] = [
    { id: "focus", name: "Focus Area", x: "10%", y: "12%", width: "40%", height: "38%", color: "#f5f5f5" },
    { id: "collab", name: "Collaboration", x: "54%", y: "12%", width: "36%", height: "38%", color: "#e5e5e5" },
    { id: "quiet", name: "Quiet Zone", x: "10%", y: "54%", width: "28%", height: "38%", color: "#d4d4d4" },
    { id: "breakout", name: "Breakout", x: "42%", y: "54%", width: "24%", height: "38%", color: "#c4c4c4" },
    { id: "phone", name: "Phone Booth", x: "70%", y: "54%", width: "20%", height: "38%", color: "#b5b5b5" }
  ];
      ...
      <DraggableActionCircles rooms={rooms}>
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="px-6 py-2 bg-gray-800 text-white rounded-full">First Floor (Level 4)</div>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-2 bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mt-4 text-sm text-gray-700"><p>Total Floor Area: 480 m² | Floor: First Floor</p></div>
            </motion.div>
